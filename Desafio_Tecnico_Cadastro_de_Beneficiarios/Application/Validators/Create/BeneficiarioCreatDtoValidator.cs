...
using Desafio_Tecnico_Cadastro_de_Beneficiarios.Application.Utils;
using FluentValidation;

namespace Desafio_Tecnico_Cadastro_de_Beneficiarios.Application.Validators.Create
{
    public class BeneficiarioCreatDtoValidator : AbstractValidator<BeneficiarioCriacaoDto>
    {
        public BeneficiarioCreatDtoValidator()
        {
